...
class ParserTest < Test::Unit::TestCase
  ...
  def test_def
    code = load_test_code "example_def.bio"
  ...
  def test_def_with_param
    code = load_test_code "example_def_params.bio"
  ...
  def test_class
    code = load_test_code "example_class.bio"
  ...
  def test_if
    code = load_test_code "example_if.bio"
  ...
  def test_while
    code = load_test_code "example_while.bio"
